                ...
                <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    <form action="{{route('submit')}}" method="post">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6">
                                <select class="form-select border-0" name="select_service" style="height: 55px;">
                                    <option selected>Select A Service</option>
                                    <option value="quality_servicing">Quality Servicing</option>
                                    <option value="expert_workers">Expert Workers</option>
                                    <option value="modern_equipment">Modern Equipment</option>
                                </select>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="date" id="date1" data-target-input="nearest">
                                    <input type="text" name="select_date"
                            ...
                            <div class="col-12">
                                ...
                                @else
                                <a href="{{route('login')}}" class="btn btn-secondary w-100 py-3"   >Book Now</a>
                                @endif
                            </div>
                        </div>
                    </form>
